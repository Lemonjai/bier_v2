...
class BeercoloursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beercolour" do
    assert_difference('Beercolour.count') do
      post beercolours_url, params: { beercolour: { hexcode: @beercolour.hexcode, name: @beercolour.name } }
    end
  ...
  test "should update beercolour" do
    patch beercolour_url(@beercolour), params: { beercolour: { hexcode: @beercolour.hexcode, name: @beercolour.name } }
